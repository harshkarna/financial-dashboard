          ...
          <div className="w-full max-w-md">
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl border border-white/20 p-8">
              ...
              <div className="mt-8 p-4 bg-black/20 rounded-xl border border-white/10">
                <div className="text-xs text-gray-400 mb-2">Preview Features:</div>
                <div className="space-y-2">
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-gray-300">💰 Net Worth</span>
                    <span className="text-green-400">₹85,11,345</span>
                  </div>
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-gray-300">💳 Monthly Budget</span>
                    <span className="text-blue-400">₹1,46,056</span>
                  </div>
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-gray-300">📈 Savings Rate</span>
                    <span className="text-purple-400">64.8%</span>
                  </div>
                </div>
              </div>
            </div>
